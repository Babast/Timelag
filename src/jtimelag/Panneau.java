...
public class Panneau extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        g2d.drawLine(0, hauteurTriangle, hauteurTriangle, 0);
        g2d.drawLine(0, hauteurTriangle, 0, hauteurTriangle);
        g2d.drawLine(hauteurTriangle, 0, hauteurTriangle, hauteurTriangle);
